...
/*
 * @param {boolean} interval: optional argument defaults to true
  ...
  try {
    ...
    if (interval === true) {
      ...
      theWhole.match(new RegExp(monthsWithStrings, 'i'))
        ...
        : (actualDateStrings = moment(theWhole.match(/[0-9]{4}\.[0-9]{2}\.[0-9]{2}\./), 'YYYY-MM-DD').format('MMMM DD'))

      console.log(theWhole + ': ' + actualDateStrings)
